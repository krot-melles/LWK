...
#define DEF_FREQUENCY_UP_THRESHOLD_L		(95)
#define DEF_FREQUENCY_UP_STEP_LEVEL_B		(700000)
#define DEF_FREQUENCY_UP_STEP_LEVEL_L		(500000)
#define DEF_FREQUENCY_DOWN_STEP_LEVEL           (700000)
#define DEF_FREQUENCY_DOWN_DIFFER_L		(3)
#define DEF_FREQUENCY_HIGH_ZONE			(700000)
#define DEF_FREQUENCY_CONSERVATIVE_STEP		(100000)
#define MICRO_FREQUENCY_UP_THRESHOLD_H		(99)
#define MICRO_FREQUENCY_UP_THRESHOLD_L		(95)
#define MICRO_FREQUENCY_UP_STEP_LEVEL_B		(600000)
#define MICRO_FREQUENCY_UP_STEP_LEVEL_L		(300000)
