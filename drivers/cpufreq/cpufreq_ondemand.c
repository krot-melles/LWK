...
#define DEF_FREQUENCY_UP_STEP_LEVEL_B		(600000)
#define DEF_FREQUENCY_UP_STEP_LEVEL_L		(300000)
#define DEF_FREQUENCY_DOWN_STEP_LEVEL           (700000)
#define DEF_FREQUENCY_DOWN_DIFFER_L		(3)
#define DEF_FREQUENCY_HIGH_ZONE			(500000)
...
#define MICRO_FREQUENCY_UP_STEP_LEVEL_B		(250000)
#define MICRO_FREQUENCY_UP_STEP_LEVEL_L		(100000)
