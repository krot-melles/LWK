...
#define DEF_FREQUENCY_UP_THRESHOLD_MULTY	(50)
#define DEF_FREQUENCY_UP_THRESHOLD_ANY_CPU	(50)
...
#define DEF_POWER_SAVE_FREQUENCY		(900000)
#define DEF_TWO_PHASE_FREQUENCY			(1800000)
#define DBS_INPUT_EVENT_MIN_FREQ		(900000)
#define DEF_FREQUENCY_OPTIMAL			(1200000)
