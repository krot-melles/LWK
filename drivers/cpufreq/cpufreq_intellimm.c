...
#define DEF_FREQUENCY_UP_THRESHOLD_MULTY	(96)
#define DEF_FREQUENCY_UP_THRESHOLD_ANY_CPU	(96)
...
#define DEF_POWER_SAVE_FREQUENCY		(200000)
#define DEF_TWO_PHASE_FREQUENCY			(1000000)
#define DBS_INPUT_EVENT_MIN_FREQ		(400000)
#define DEF_FREQUENCY_OPTIMAL			(600000)
#define DEF_FREQ_DOWN_STEP			(100000)
#define DEF_FREQ_DOWN_STEP_BARRIER		(300000)
