...
ARCH		?= arm
CROSS_COMPILE	?= ../uber/bin/arm-linux-androideabi-
...
HOSTCC       = ccache gcc
HOSTCXX      = ccache g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -Os -fomit-frame-pointer -fgraphite
HOSTCXXFLAGS = -Os -fgraphite
